...
public class ProductsController {
	...
	public ResponseEntity<?> addProduct(@RequestBody ProductDTO dto) {
		return new ResponseEntity<SuccessResponseDTO>(new SuccessResponseDTO(productService.addProduct(dto)),
				HttpStatus.CREATED);
	}
	...
	public ResponseEntity<?> addMultipleProducts(@RequestBody List<ProductDTO> products) throws ConflictException {
		...
		return new ResponseEntity<SuccessResponseDTO>(new SuccessResponseDTO(productService.uploadProducts(products)),
				HttpStatus.CREATED);
	...
	public ResponseEntity<?> updateProduct(@RequestBody ProductDTO dto, @PathVariable Long productId)
			throws DataNotFoundException {
		return new ResponseEntity<SuccessResponseDTO>(
				new SuccessResponseDTO(productService.updateProduct(dto, productId)), HttpStatus.ACCEPTED);
	}
	...
	public ResponseEntity<?> deleteProduct(@PathVariable Long productId) throws DataNotFoundException {
		return new ResponseEntity<SuccessResponseDTO>(new SuccessResponseDTO(productService.deleteProduct(productId)),
				HttpStatus.OK);
	}
